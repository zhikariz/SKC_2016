...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2016 at 06:02 AM
...
INSERT INTO `peserta` (`id_peserta`, `nama`, `id_kontingen`, `berat_badan`, `tgl_lahir`, `waktu_input`, `perguruan`, `jk`, `id_kelas`) VALUES
...
--
ALTER TABLE `peserta`
  MODIFY `id_peserta` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=649;
