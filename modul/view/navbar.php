      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span> Manage <b class="caret"></b></a>
          <ul class="dropdown-menu">
            ...
            <li class="pr-admin divider"></li>
            <li class="pr-user"><a href="./?<?php echo $link_manage_kontingen; ?>"><span class="glyphicon glyphicon-globe"> </span> Manage Kontingen</a></li> 
            <li class="pr-admin divider"></li>
            <li class="pr-admin"><a href="./?<?php echo $link_manage_kelas; ?>"><span class="glyphicon glyphicon-folder-open"> </span> Manage Kelas</a></li>
