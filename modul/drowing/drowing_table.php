...
<div class="container">
    ...
    <div class="row row-centered">
        <h1>Drowing <br><small><?php echo $kelas_val_conv[$id_kelas]; ?></small></h1>
        ...
        <h3 class="page-header">Pool : <?php echo $pool; ?> - <span class="label label-danger"><?php echo $jml_pool_ini; ?></span> Peserta</h3>
        <div class="col-md-12">
